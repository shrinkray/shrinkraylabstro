...
<Image src={import('~/assets/images/insider-preview_1.jpg')} alt="Insider Preview view with the Editions menu open"/>
...
<Image src={import('~/assets/images/import-vdhx_2.jpg')} alt="A view of the Import VHDX image dialog"/>
...
<Image src={import('~/assets/images/mem-cores-setup_3.jpg')} alt="Insider Preview view with the Editions menu open"/>
...
<Image src={import('~/assets/images/spice-installer_6.jpg')} alt="Install SPICE tools from Windows Explorer drives"/>
